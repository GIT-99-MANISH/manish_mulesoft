...
movies = [
    {'title': 'IRON MAN', 'year': 208, 'director': 'JON FAVREAU', 'actor': 'ROBERT DOWNEY JR', 'actress': 'GWYNETH PALTROW'},
...
cursor.execute("CREATE TABLE Movies3 (title VARCHAR(60), actor VARCHAR(24), actress VARCHAR(24), year INT(4), director VARCHAR(24));")
